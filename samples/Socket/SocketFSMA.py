...
# 48 states, 100 transitions, 17 accepting states, 0 finished and 0 deadend states
...
states = {
  ...
  43 : {'Socket': {'exception': '', 'recv_closed': False, 'send_arg': 'a', 'recv_arg': 4, 'send_closed': False, 'buffers': 'aaaa'}},
  44 : {'Socket': {'exception': '', 'recv_closed': False, 'send_arg': '', 'recv_arg': 4, 'send_closed': True, 'buffers': 'aaaa'}},
  ...
  47 : {'Socket': {'exception': '', 'recv_closed': False, 'send_arg': '', 'recv_arg': 4, 'send_closed': False, 'buffers': 'aaaaa'}},
}
...
graph = (
  ...
  (13, (recv_return, ('',), None), 13),
  (14, (send_return, (1,), None), 19),
  (15, (recv_return, ('',), None), 15),
  (16, (recv_return, ('a',), None), 1),
  (16, (send_return, (1,), None), 20),
  (17, (recv_return, ('',), None), 13),
  (17, (recv_return, ('a',), None), 4),
  ...
  (22, (recv_return, ('',), None), 22),
  (23, (send_return, (1,), None), 28),
  (24, (recv_return, ('',), None), 24),
  (25, (recv_return, ('a',), None), 12),
  (25, (send_return, (1,), None), 29),
  (26, (recv_return, ('',), None), 22),
  (26, (recv_return, ('a',), None), 13),
  ...
  (31, (recv_return, ('',), None), 31),
  (32, (send_return, (1,), None), 37),
  (33, (recv_return, ('',), None), 33),
  (34, (recv_return, ('a',), None), 21),
  (34, (send_return, (1,), None), 38),
  (35, (recv_return, ('',), None), 31),
  (35, (recv_return, ('a',), None), 22),
  ...
  (38, (send_call, ('a',), None), 43),
  (38, (recv_return, ('a',), None), 27),
  (38, (send_close, (), None), 44),
  (39, (recv_close, (), None), 41),
  (39, (recv_call, (4,), None), 43),
  (39, (send_return, (1,), None), 45),
  (40, (recv_close, (), None), 42),
  (40, (recv_call, (4,), None), 44),
  (40, (recv_return, ('',), None), 40),
  (41, (send_return, (1,), None), 46),
  (42, (recv_return, ('',), None), 42),
  (43, (recv_return, ('a',), None), 30),
  (43, (send_return, (1,), None), 47),
)
